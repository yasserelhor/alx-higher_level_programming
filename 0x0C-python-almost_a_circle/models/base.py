...
class Base:
    ...
    def to_json_string(list_dictionaries):
        '''JSON-ify a dictionary for a more concise and readable format.'''
    ...
    def create(cls, **dictionary):
        '''Load instance from a dictionary.'''
    ...
    def load_from_file(cls):
        '''Load string from file and de-JSON-ify.'''
        from os import path
